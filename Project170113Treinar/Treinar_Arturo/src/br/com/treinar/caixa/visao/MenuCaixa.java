...
public class MenuCaixa {
	...
	private void cadastrarContaInvestimento() {
		// aplica as funcionalidades dos metodos sobreescritos em
		// ContaInvestimento(filho)
		...
		// faz um cast do objeto c e o atribui a variavel do tipo
		// ContaInvestimento
		// para poder utilizar os metodos e variaveis especificas da classe
		// ContaInvestimento
		ContaInvestimento contaInvestimento = (ContaInvestimento) c;
		contaInvestimento.taxaManutencao = leitor.nextDouble(); // define a taxa
																// de manuten��o
																// que �
																// especifica de
																// uma conta
		...
		contaInvestimento.taxaRendimento = leitor.nextDouble(); // define uma
																// taxa de
																// rendimento
	}
	...
	private void cadastrarContaCorrente() {
		...
		contaCorrente.atribuirLimiteCredito(limiteCredito); // chama o metodo
															// que atribui um
															// limite de credito
															// passando seu
															// valor
	...
	public void cadastrarConta(Conta conta) {
		...
		leitor.nextLine();
		c.cliente = new Cliente(); // atribui um novo cliente, a variavel
									// cliente dentro da conta recebida
		c.cliente.setNome(leitor.nextLine()); // atribui o nome do cliente a
												// variavel nome dentro do
												// objeto cliente contido na
												// conta recebida
		System.out.print("Informe o endereco do cliente: ");
		c.cliente.setEndereco(leitor.nextLine()); // atribui o endere�o do
													// cliente a variavel
													// endere�o dentro do objeto
													// cliente contido na conta
													// recebida
		System.out.print("Informe o documento do cliente: ");
		c.cliente.setDocumento(leitor.nextInt()); // atribui o documento do
													// cliente a variavel
													// documento dentro do
													// objeto cliente contido na
													// conta recebida
